...
var feedback = "";
feedback += "<p>Basd on your average daily use of "+Math.round(dailyUseKw)+" kwh, you will need to purchase "+panelsNeeded+"  "+panelName+" solar panels to offset 100% of your elecricity bill. </p>";
feedback += "<h2>Additional Details</h2>";
	feedback += "<p>Your average daily electiricity consumption: " + Math.round(dailyUseKw) +" Kwh per day.</p>";
